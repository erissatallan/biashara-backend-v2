...
exports.lowSalesRecoveryJob = void 0;
...
exports.lowSalesRecoveryJob = new lua_cli_1.LuaJob({
    ...
    execute: async (job) => {
        ...
        try {
            ...
            const todaySummary = todayRes.ok ? await todayRes.json() : null;
            ...
            const userPrompt = `Today's revenue: KES ${Math.round(todayRevenue).toLocaleString()}\n` +
            ...
            for (const phoneNumber of CUSTOMER_PHONE_NUMBERS) {
                try {
                    const customer = await lua_cli_1.User.get(phoneNumber);
                    if (customer) {
...
//# sourceMappingURL=lowSalesRecovery.js.map