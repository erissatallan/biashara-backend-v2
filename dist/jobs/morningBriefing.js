...
exports.morningBriefingJob = void 0;
 ...
 * not a meta-prompt.
 */
exports.morningBriefingJob = new lua_cli_1.LuaJob({
    ...
    execute: async (job) => {
        ...
        try {
            ...
            const systemPrompt = `You are Biashara, an AI business agent for the owner of Zawadi General Store in Westlands, Nairobi. ` +
            ...
            const userPrompt = `7-day transaction summary (JSON):\n${JSON.stringify(summary, null, 2)}\n\n` +
