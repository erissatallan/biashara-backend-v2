...
export class SendCustomerCampaignTool implements LuaTool {
    name = 'send_customer_campaign';
    description = `Send a promotional discount campaign to registered customers via WhatsApp.
...
2 per day maximum.`;
    ...
    async execute(input: { discountPercent: number; reason?: string }) {
        try {
